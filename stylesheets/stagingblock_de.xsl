...
<xsl:template match="/">
	...
	<html>
		<head>
			<title>Rocrail Aufstell-Blockreports</title>
		</head>
		<body>
			<br /><br />
			<h2>Liste aller definierten Aufstell-Bl&#246;cke</h2>
			Rocrail-Version: <xsl:value-of select="plan/@rocrailversion" />
			<table border="1" rules="all" cellpadding="4" cellspacing="0" width="100%">
				<THEAD>
					<TR>
						<TH bgcolor="lightgrey">lfd. Nr.</TH>
						<TH bgcolor="lightgrey">Kennung</TH>
						<TH bgcolor="lightgrey">Beschreibung</TH>
						<TH bgcolor="lightgrey">Abschnittsl&#228;nge</TH>
						<TH bgcolor="lightgrey">Zugabstand</TH>
						<TH bgcolor="lightgrey">Einfahrtmelder</TH>
						<TH bgcolor="lightgrey">Einfahrsignal</TH>
						<TH bgcolor="lightgrey">Ausfahrsignal</TH>
						<TH bgcolor="lightgrey">Zufallsrate</TH>
					</TR>
					<TR>
						<TH bgcolor="lightgrey">&#160;</TH>
						<TH bgcolor="lightgrey">&#160;</TH>
						<TH bgcolor="lightgrey">Abfahrt</TH>
						<TH bgcolor="lightgrey">Ankunft</TH>
						<TH bgcolor="lightgrey">Wartetyp</TH>
						<TH bgcolor="lightgrey">&#160;</TH>
						<TH bgcolor="lightgrey">&#160;</TH>
						<TH bgcolor="lightgrey">&#160;</TH>
						<TH bgcolor="lightgrey">&#160;</TH>
