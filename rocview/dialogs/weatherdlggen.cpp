...
WeatherDlgGen::WeatherDlgGen( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bSizer2->Add( m_SunriseBox, 1, wxEXPAND|wxTOP|wxRIGHT|wxLEFT, 5 );
	...
	m_WeatherBook->AddPage( m_DayPanel, wxT("Day"), true );
	...
	m_ThemeSoundRandomRate = new wxSpinCtrl( m_ThemePanel, wxID_ANY, wxT("5"), wxDefaultPosition, wxSize( 80,-1 ), wxSP_ARROW_KEYS, 0, 9, 5 );
